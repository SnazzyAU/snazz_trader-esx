...
function OpenMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'trader_choice', {
		title    = "Wandering Trader",
		align    = "bottom-right",
		elements = {
			{label = 'Buy Items/Weapons', value = 'buy'},
			{label = 'Sell Items/Weapons', value = 'sell'}
		}
	}, function(data, menu)
		...
		if data.current.value == 'buy' then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'trader_menu', {
				title    = "Wandering Trader",
				align    = "bottom-right",
				elements = elements
			}, function(data2, menu2)
		
				ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'trader_confirm', {
...
AddEventHandler('snazz:spawnNPC', function(location)
	...
	print(curRanPos)
	blip = AddBlipForRadius(curRanPos[1], curRanPos[2], curRanPos[3], 70.0)
...
AddEventHandler('snazz:deleteNPC', function()
	DeleteEntity(trader)
	ESX.UI.Menu.Close('default',GetCurrentResourceName(),'trader_choice')
	ESX.UI.Menu.Close('default',GetCurrentResourceName(),'trader_menu')
	ESX.UI.Menu.Close('default',GetCurrentResourceName(),'trader_confirm')
